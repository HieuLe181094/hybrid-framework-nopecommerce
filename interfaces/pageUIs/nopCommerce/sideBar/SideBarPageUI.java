...
public class SideBarPageUI {
    ...
    public static final String DYNAMIC_SIDEBAR_LINK_BY_NAME = "Xpath=//div[contains(@class,'account-navigation')]//a[text()='%s']";

    public static final String NEW_ADDRESSED_SUCCESS_MESSAGE = "Xpath=//div[@class='bar-notification success']/p";
}