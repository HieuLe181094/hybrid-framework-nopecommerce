...
import data.employee.EmployeeData;
...
public class Level_25_Manage_Data_05_JSON_Object extends BaseTest {
    ...
    public void beforeClass(String urlValue, String browserName) throws IOException {
       ...
       System.out.println("Skilltree = " + employeeData.getSkilltree().get(0));
       System.out.println("Skilltree = " + employeeData.getSkilltree().get(1));
       System.out.println("Skilltree = " + employeeData.getSkilltree().get(2));

       for (int i = 0; i < employeeData.getSkilltree().size(); i++){
            System.out.println(("Skilltree = " + employeeData.getSkilltree().get(i)));
       }

       System.out.println("Address Street = " + employeeData.getAddress().getStreetName());
       System.out.println("Address Number = " + employeeData.getAddress().getStreetNumber());
